...
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {v40_vld}]
set_input_delay -clock [get_clocks {clk}] 0.0 [get_ports {v40_rdy}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {v40_dat[*]}]
