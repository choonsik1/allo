...
def get_eva_top(Ty: AlloType = float16):
    ...
    def top(
        ...
        # TIMESTAMP outputs: collectors stamp the production cycle t
        ...
        cr_e: Channel[int32, valid_ready][M, N + 1]
        cr_w: Channel[int32, valid_ready][M, N + 1]
        cr_s: Channel[int32, valid_ready][M + 1, N]
        cr_n: Channel[int32, valid_ready][M + 1, N]
