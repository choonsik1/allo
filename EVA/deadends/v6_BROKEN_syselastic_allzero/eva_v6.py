        ...
        def node(pcfg: int32[M, N]):
            ...
            for t in range(NSTEP):
                ...
                if txp_v[0] == 1:
                    ...
                    txn_r = twn   # v6: txp_v[0] held until granted
                if txp_v[1] == 1:
                    tws: SYS_W = 0
                    tws[0] = 1
                    tws[1 : 1 + Ty.bits] = txp_d[1].bitcast()
                    txs_r = tws   # v6: txp_v[1] held until granted
                if txp_v[2] == 1:
                    tww: SYS_W = 0
                    tww[0] = 1
                    tww[1 : 1 + Ty.bits] = txp_d[2].bitcast()
                    txw_r = tww   # v6: txp_v[2] held until granted
                if txp_v[3] == 1:
                    twe: SYS_W = 0
                    twe[0] = 1
                    twe[1 : 1 + Ty.bits] = txp_d[3].bitcast()
                    txe_r = twe   # v6: txp_v[3] held until granted
                if crv_vld == 1:
                    if crv_mode == 1:
